...
const Signalement = () => {
  ...
  // The value actually sent to the API
  const categorieFinale = form.categorie === 'AUTRE'
    ? categorieCustom.trim()
    : form.categorie;
  ...
  const handleSubmit = async (e) => {
    ...
    if (form.categorie === 'AUTRE' && !categorieCustom.trim()) {
        ...
        <div style={S.scrollArea}>
          ...
          <div style={S.card} className="fade-in">
            <form onSubmit={handleSubmit}>
              ...
              {/* Custom category input — shown only when "Autre" is selected */}
              {form.categorie === 'AUTRE' && (
                <div style={{ ...S.inputWrap, marginTop: '-10px' }} className="fade-in">
                  <input
                    ...
                    onChange={e => { setError(''); setCategorieCustom(e.target.value); }}
                    required
                    autoFocus
                    style={{
                      ...S.input,
