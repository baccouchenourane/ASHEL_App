...
const BulletinB3Form = ({ onBack }) => {
  ...
  const handleDownload = () => {
    ...
    doc.text('DIRECTION GENERALE DE LA SURETE NATIONALE', 105, 37, { align: 'center' });
    
    doc.setLineWidth(0.8);
    doc.line(70, 42, 140, 42);

    doc.setFontSize(18);
    doc.text('BULLETIN N3 (B3)', 105, 60, { align: 'center' });

    doc.setFont('helvetica', 'normal');
    doc.setFontSize(11);
    doc.text(`Reference : ${reference}`, 20, 80);
    doc.text(`Date d'emission : ${dateStr}`, 20, 87);
    ...
    doc.setFont('helvetica', 'normal');
    doc.text(`Nom et Prenom : ${cardHolder.toUpperCase()}`, 30, 120);
    doc.text('Observation : NEANT (Casier Judiciaire Vierge)', 30, 130);

    doc.rect(150, 220, 30, 30);
    doc.setFontSize(7);
    doc.text('CACHET ELECTRONIQUE', 147, 215);
            ...
            <div style={{ textAlign: 'center' }} className="scale-in">
              ...
              <div style={receipt}>
                <div style={receiptTop}>
                  ...
                  <h4 style={{ margin: '10px 0', fontWeight: '900' }}>B3 EN TRAITEMENT</h4>
                ...
                <div style={receiptLine}><span>Statut</span> <b style={{ color: '#F59E0B' }}>Signature en cours</b></div>
...
const cardPreview = (type) => ({
  ...
  background: type === 'visa' ? 'linear-gradient(135deg, #1a1a1a 0%, #4a4a4a 100%)' : 'linear-gradient(135deg, #334155 0%, #0f172a 100%)',
