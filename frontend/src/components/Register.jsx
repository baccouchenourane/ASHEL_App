...
const RegisterForm = () => {
  ...
  // Logique d'inscription et redirection CORRIGÉE
  const handleBiometricScan = async () => {
    ...
    setTimeout(async () => {
      try {
        setIsScanning(false);  // ✅ Corrigé
        setLoading(true);       // ✅ Corrigé

        // Appel au Backend (Tu peux commenter cette ligne pour tester sans backend)
...
const styles = {
  card: { paddingTop: '10px' }, // ✅ Corrigé : Ajouté pour l'affichage
