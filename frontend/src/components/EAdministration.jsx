...
import BulletinB3Form from './BulletinB3Form'; 
import RegisterForm from './RegisterForm'; 
import WorkCertificateForm from './WorkCertificateForm';
import ResidenceCertificateForm from './ResidenceCertificateForm';
...
const SERVICES = [
  { id: 1, title: "Extrait de Naissance", cat: "Famille", icon: <Users size={22} />, component: BirthCertificationForm },
  { id: 2, title: "Bulletin N°3", cat: "Justice", icon: <ShieldCheck size={22} />, component: BulletinB3Form },
  { id: 3, title: "Registre de Commerce", cat: "RNE", icon: <Briefcase size={22} />, component: RegisterForm },
  { id: 4, title: "Attestation de Travail", cat: "Social", icon: <FileText size={22} />, component: WorkCertificateForm },
  { id: 5, title: "Certificat de Résidence", cat: "Famille", icon: <HomeIcon size={22} />, component: ResidenceCertificateForm },
  { id: 6, title: "Fiche de Paie (CNRPS)", cat: "Social", icon: <ClipboardList size={22} />, component: SalarySlipForm }
];
